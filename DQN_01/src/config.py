...
# REPLAY BUFFER
# ─────────────────────────────────────────
BUFFER_CAPACITY = 10000   # reduced from 100000
BATCH_SIZE      = 32      # reduced from 64
MIN_BUFFER_SIZE = 200     # reduced from 1000 — matches your 200 rows
...
LEARNING_RATE   = 0.001
GAMMA           = 0.99
TARGET_UPDATE_N = 100     # reduced from 300
...
# TRAINING EPISODES
# ─────────────────────────────────────────
MAX_EPISODES = 500    # reduced from 1000
MAX_STEPS    = 200    # fixed from 00# src/config.py
